...
<div class="card bg-base-100 shadow mt-10">
	<div class="card-body gap-4">
		...
		<div class="flex flex-col md:flex-row md:items-center gap-3 justify-end">
		...
		<div class="flex justify-end">
			<div class="searchBox">
				<form action="">
					...
					<div class="flex">
						<select class="select select-sm select-boardered max-w-xs border-gray-600" name="searchKeywordTypeCode"
						...
						<label class="ml-3 input input-boardered input-sm flex items-center gap-2 border-gray-600">
